...
public class GlobalException {
	...
	public ResponseEntity<ErrorDetails> studentExceptionHandler(StudentException ie, WebRequest req)  {
	...
	public ResponseEntity<ErrorDetails> courseExceptionHandler(CourseException ie, WebRequest req)  {
